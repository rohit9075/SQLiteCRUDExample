...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(rohit.com.sqlitecrudexample.R.layout.activity_main);

        textViewViewEmployees = (TextView) findViewById(rohit.com.sqlitecrudexample.R.id.textViewViewEmployees);
        editTextName = (EditText) findViewById(rohit.com.sqlitecrudexample.R.id.editTextName);
        editTextSalary = (EditText) findViewById(rohit.com.sqlitecrudexample.R.id.editTextSalary);
        spinnerDepartment = (Spinner) findViewById(rohit.com.sqlitecrudexample.R.id.spinnerDepartment);

        findViewById(rohit.com.sqlitecrudexample.R.id.buttonAddEmployee).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case rohit.com.sqlitecrudexample.R.id.buttonAddEmployee:
                addEmployee();
                break;

            case rohit.com.sqlitecrudexample.R.id.textViewViewEmployees:
